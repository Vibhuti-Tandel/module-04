...
<title>Practical 7 Bootstrap CRUD Data Table for Database with Modal Form</title>
			...
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>View Deleted Record</span></a>						
					</div>
				</div>
			</div>
